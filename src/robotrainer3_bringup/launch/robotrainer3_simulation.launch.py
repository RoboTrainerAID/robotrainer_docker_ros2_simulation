...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "controllers_file",
            default_value="robotrainer3_controllers.yaml",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="robotrainer3.urdf.xacro",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            choices=["forward_position_controller", "bicycle_steering_controller"],
    ...
    # control_node is already started from gz_server!
    control_node = Node(
    ...
    #     executable="create",
    #     name="spawn_robotrainer3",
    #     arguments=["-name", "robotrainer3", "-topic", "robot_description"],
    #     output="screen",
    #     condition=IfCondition(sim_gazebo),
    # )
    ...
    gazebo_classic_spawn_robot = Node(
        ...
        name="spawn_robotrainer3",
        arguments=["-entity", "robotrainer3", "-topic", "robot_description"],
        output="screen",
        condition=IfCondition(sim_gazebo_classic),
    )
