robotrainer3_description
==========================================

Descriptions files for the RoboTrainer3
...
# Create plain URDF from xacro
ros2 run xacro xacro src/robotrainer3_description/urdf/robotrainer3.urdf.xacro -o src/robotrainer3_description/urdf/robotrainer3.urdf
# Check urdf tf tree
check_urdf src/robotrainer3_description/urdf/robotrainer3.urdf
# Create pdf with tf tree
urdf_to_graphviz src/robotrainer3_description/urdf/robotrainer3.urdf src/robotrainer3_description/urdf/robotrainer3
```
...
2. Install the package by calling `colcon build --symlink-install --packages-select robotrainer3_description`
3. (Re-)Source environment `source install/setup.bash`


> **NOTE:** If you use [RosTeamWorkspace (RTW)](https://rtw.stoglrobotics.de) than instead of the previous three steps, use `cb robotrainer3_description` command.

Now, launch description test:
```
ros2 launch robotrainer3_description view_robotrainer3.launch.xml
```
or
```
ros2 launch robotrainer3_description view_robotrainer3.launch.py
